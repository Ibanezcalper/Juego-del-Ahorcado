var palabras = ["SOFIA","VALENTINA","REGINA","XIMENA","CAMILA","VALERIA","NANCY","VERONICA","JAZMIN","JOCABED","FERNANDA","HUGO","MARIO","MARTIN","PABLO","DANIEL","LUIS","AARON", "LUIS", "GEORGINA", "SOCORRO", "RAMSES", "ANGELICA", "MISHA", "CAROLINA"];
var letrasMayus = "QWERTYUIOPASDFGHJKLÑZXCVBNM";
var letraMala = "";
const pantalla1 = document.querySelector(".flexInicio");
const pantalla2 = document.querySelector(".flexJuego");
const pantalla3 = document.querySelector(".flexAgregar");
const botonJugar = document.querySelector(".flexInicioBtn1");
const botonAgregar = document.querySelector(".flexInicioBtn2");
const botonAtras = document.querySelector(".flexJuegoBtn2");
const botonDesistir = document.querySelector(".flexJuegoBtn1");
const botonJugarDeNuevo = document.querySelector(".flexJuegoBtn3");
const botonAceptar = document.querySelector(".cajaBtn");
const botonAdd = document.querySelector(".btnAdd");
const botonBack = document.querySelector(".btnBack");
const mensajeGanador = document.querySelector(".flex_ganador");
const mensajePerdedor = document.querySelector(".flex_perdedor");
const ventanaEmergente = document.querySelector(".flex_caja");
const mensajePalabra = document.querySelector(".caja_palabra");
const agregarPalabra = document.querySelector(".flexAgregarTxt");
let letra;
...
let mensaje6;
let mensaje7;
let letraErrada = document.querySelector(".flex_letraErrada");
...
function crear(array, numero){
    for(var i=0;i<array[numero].length;i++){
        ...
        document.querySelector(".flexJuegoRenglones").appendChild(newElement)
    }
}
...
function desistir(){
    ...
    for (i=0 ; i<palabras[nAleatorio].length ; i++){
        document.querySelector(".flexJuegoRenglones textarea").remove();
    }
    const var1 = document.querySelector(".linea-base-horizontal");
    const var2 = document.querySelector(".linea-base-vertical");
    const var3 = document.querySelector(".linea-sup-horizontal");
    ...
    const limpiarLetrasGrises = document.querySelector(".flex_letraErrada");
